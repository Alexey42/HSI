...
Данные не лежат в репозитории, потому что спутниковые снимки занимают слишком много места для GitHub.
...
Это учебно-исследовательский проект, поэтому в нём есть места, которые можно улучшать:

- добавить автоматические тесты для алгоритмов;
- вынести обработку снимков из UI-слоя в отдельный сервисный слой;
- улучшить обработку ошибок при чтении нестандартных наборов данных;
- привести старый WPF-проект к более современной структуре сборки.

При этом проект уже показывает полный рабочий цикл: чтение реальных спутниковых данных, обработку пиксельных массивов, визуализацию результата и сохранение выходных файлов.
